...
```r
dbconnection <- csreport::DBConnection_v9$new(
...
dbtable <- csreport::DBTable_v9$new(
  dbconfig = list(
    driver = Sys.getenv("SC9_DBCONFIG_DRIVER"),
    server = Sys.getenv("SC9_DBCONFIG_SERVER"),
    port = as.integer(Sys.getenv("SC9_DBCONFIG_PORT")),
  ...
  field_types = c(
    ...
    validator_field_types = csreport::validator_field_types_blank,
    validator_field_contents = csreport::validator_field_contents_blank
)
dbtable$insert_data(csreport::nor_covid19_cases_by_time_location)
dbtable$connect()
